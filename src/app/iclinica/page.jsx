    ...
    <div 
      ...
      <header className="flex items-center w-full justify-between p-4">
        ...
        <div className="flex flex-wrap items-center justify-center h-screen gap-2">
            <Image  alt="login" src={"/iclinica/login.jpeg"} width={600} height={600} />

            <Image alt="home" src={"/iclinica/home.jpeg"} width={600} height={600} />

            <Image alt="agenda" src={"/iclinica/agenda.jpeg"} width={600} height={600} />

            <Image alt="pacientes" src={"/iclinica/pacientes.jpeg"} width={600} height={600} />
        </div>
