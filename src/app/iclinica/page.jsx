...
import CarrosselIclinica from "./carrosselIclinica";
  ...
  return (
    ...
    >
      <header className="flex items-center w-full justify-between p-4">
        <h1 className="md:text-3xl text-2xl text-white">Iclinica</h1>
      ...
      >
        ...
        <p className="md:w-[500px]  w-[300px]">
          Sistema web voltado para a gestão de clínicas médicas. Desenvolvido
          com TypeScript em todo o stack, utilizando Vite e React no front-end
          para performance e modularidade, e Express no back-end para construção
          de uma API leve e organizada. A aplicação permite o gerenciamento de
          pacientes, agendamentos, e prontuários, com foco na usabilidade e
          segurança de dados.
        </p>
      </section>
      <section
