    ...
    <div 
      ...
      <header className="flex items-center w-full justify-between p-4">
        ...
        <div className="flex flex-wrap items-center justify-center h-screen gap-2">
            <Image  alt="login" src={"/gerenciamentotarefas/login.jpeg"} width={600} height={600} />

            <Image alt="cadastro" src={"/gerenciamentotarefas/cadastro.jpeg"} width={600} height={600} />
