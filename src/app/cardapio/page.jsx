...
import CarrosselCardapio from "./carrosselCardapio";
  ...
  return (
    ...
    >
      <header className="flex items-center w-full justify-between p-4">
        <h1 className="md:text-3xl text-2xl text-white">Cardápio</h1>
      ...
      >
        ...
        <p className="md:w-[500px]  w-[300px]">
          ...
          pequenos comércios. Desenvolvido com React e Vite para garantir uma
          interface rápida e responsiva. Utiliza o LocalStorage para
          persistência de dados localmente, sem necessidade de back-end. Conta
          com um sistema de geração de links personalizados para
          redirecionamento direto ao WhatsApp, facilitando pedidos e
          atendimento.
        </p>
      </section>
      <section
